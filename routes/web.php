...
Route::group(['prefix' => 'attendance', 'as' => 'attendance.'], function () {
    ...
    Route::group(['prefix' => 'student'], function () {
        Route::get('/', [
            'as' => 'student',
            'uses' => 'Attendance\StudentAttendanceController@index'
        ]);
        
        Route::get('import', [
            'as' => 'student.import',
            'uses' => 'Attendance\StudentAttendanceController@importAttendance'
        ]);
        
        Route::post('import', [
            'as' => 'student.import',
            'uses' => 'Attendance\StudentAttendanceController@handleImport'
        ]);
        
        Route::get('import-sample', [
            'as' => 'student.import-sample',
            'uses' => 'Attendance\StudentAttendanceController@downloadSample'
        ]);
    });
});