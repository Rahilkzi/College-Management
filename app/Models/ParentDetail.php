...
class ParentDetail extends BaseModel
{
    protected $fillable = ['created_by', 'last_updated_by', 'students_id', 'grandfather_first_name', 'grandfather_middle_name',
        'grandfather_last_name', 'father_first_name', 'father_middle_name', 'father_last_name', 'father_qualification',
        ...
        'mother_qualification', 'mother_occupation', 'mother_office', 'mother_office_number', 'mother_residence_number',
