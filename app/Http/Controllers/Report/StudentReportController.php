    ...
    public function index(Request $request)
    {
        ...
        if ($request->all()){
            $data['student'] = Student::select('students.id','students.reg_no', 'students.reg_date', 'students.serial_no',
                ...
                'pd.father_middle_name', 'pd.father_last_name', 'pd.father_qualification', 'pd.father_occupation',
                ...
                'pd.mother_qualification', 'pd.mother_occupation', 'pd.mother_office', 'pd.mother_office_number',
