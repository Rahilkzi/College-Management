                                        ...
                                        <div class="row">
                                            <table>
                                                ...
                                                <tr>
                                                    <td>
                                                        <table
                                                            class="table table-striped table-bordered no-margin-bottom">
                                                            <thead>
                                                            ...
                                                            <tbody>
                                                                @if(isset($data['student']->paid_amount) && $data['student']->paid_amount > 0)
                                                                    <tr>
                                                                        <td>
                                                                            Amount Received On
                                                                            {{ \Carbon\Carbon::parse($data['student']->paid_date)->format('Y-m-d')}}
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td class="text-uppercase" colspan="2">
                                                                            Amount In Word:<strong>
                                                                                {{ ViewHelper::convertNumberToWord(isset($data['student']->paid_amount) ? $data['student']->paid_amount : 0) }}only.</strong>
                                                                        </td>
                                                                    </tr>
                                                                @endif
                                                            </tbody>
                                            ...
                                            <table>
                                                <tr>
                                                    <td width="10%" rowspan="4">
                                                        @if($data['student']->reg_no != '')
                                                        @php($amount
                                                        =isset($data['student']->paid_amount)?$data['student']->paid_amount:0)
                                                        @php($name = $data['student']->first_name.'
                                                        '.$data['student']->middle_name.' '.$data['student']->last_name)
                                                        @php($regNo = $data['student']->reg_no)
                                                        @php($date = \Carbon\Carbon::parse(now())->format('Y-m-d'))
                                                        {!! QrCode::size(200)->generate('Name:'.$name.',
                                                        Reg.No:'.$regNo.', Date'.$date.', Amount:'.$amount); !!}
                                                        @else
                                                        @endif
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <table
                                                            ...
                                                            <tbody>
                                                                @if(isset($data['student']->paid_amount) &&
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        {{ number_format($data['student']->paid_amount,
                                                                        2) }}/-
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="text-uppercase" colspan="2">
                                                                        Amount In Word:<strong> {{
                                                                            ViewHelper::convertNumberToWord(isset($data['student']->paid_amount)?$data['student']->paid_amount:0)
                                                                            }}only.</strong>
                                                                    </td>
                                                                </tr>
                                                                @endif
