        ...
        <div>
            <span class="profile-picture">
                @if($data['student']->student_image != '')
                    <img id="avatar" class="editable img-responsive" alt="{{ $data['student']->title }}"
                        src="{{ asset('images' . DIRECTORY_SEPARATOR . $folder_name . DIRECTORY_SEPARATOR . $data['student']->student_image) }}"
                        width="250px" />
                @else
                    <img id="avatar" class="editable img-responsive" alt="{{ $data['student']->title }}"
                ...
                @if($data['student']->student_signature != '')
                    <span class="profile-picture align-center">
                        <img class="editable img-responsive" alt="{{ $data['student']->title }}"
                            src="{{ asset('images' . DIRECTORY_SEPARATOR . $folder_name . DIRECTORY_SEPARATOR . $data['student']->student_signature) }}"
                            width="190px" />
                    </span>
                @else
    ...
    $data['student']->middle_name . ' ' . $data['student']->last_name }}</div>
        ...
        <div class="profile-user-info profile-user-info-striped">
            ...
            <div class="profile-info-row">
                @if($data['student']->first_name_dev != "")
                    <div class="profile-info-name"> Name: </div>
                    <div class="profile-info-value">
                        <span class="editable"
                            id="faculty">{{  $data['student']->first_name_dev . ' ' . $data['student']->middle_name_dev . ' ' . $data['student']->last_name_dev }}</span>
                    </div>
            ...
            <div class="profile-info-row">
                @if($data['student']->faculty != "")
                    ...
                    <div class="profile-info-value">
                        <span class="editable"
                            id="faculty">{{  ViewHelper::getFacultyTitle($data['student']->faculty) }}</span>
                    </div>
                @endif
                @if($data['student']->semester != "")
                    ...
                    <div class="profile-info-value">
                        <span class="editable"
                            id="semester">{{  ViewHelper::getSemesterTitle($data['student']->semester) }}</span>
                    </div>
                @endif
            </div>
            <div class="profile-info-row">
                @if($data['student']->batch != "")
                    ...
                    <div class="profile-info-value">
                        <span class="editable"
                            id="faculty">{{  ViewHelper::getStudentBatchId($data['student']->batch) }}</span>
                    </div>
                @endif
            </div>
            ...
            <div class="profile-info-row">
                ...
                @if($data['student']->mobile_1 != "")
                    ...
                    <div class="profile-info-value">
                        <span class="editable"
                            id="email">{{ $data['student']->mobile_1 . ',' . $data['student']->mobile_2 }}</span>
                    </div>
                @endif
            </div>
        </div>
    ...
    @if($data['student']->grandfather_first_name != "")
        ...
        <div class="profile-user-info profile-user-info-striped">
            <div class="profile-info-row">
                ...
                <div class="profile-info-value">
                    <span class="editable"
                        id="temporary_place">{{ $data['student']->grandfather_first_name . ' ' . $data['student']->grandfather_middle_name . ' ' . $data['student']->grandfather_last_name }}</span>
                </div>
            </div>
        </div>
    @endif
    ...
    <div class="profile-user-info profile-user-info-striped">
        <div class="profile-info-row">
            @if($data['student']->father_first_name != "")
                ...
                <div class="profile-info-value">
                    <span class="editable"
                        id="temporary_place">{{ $data['student']->father_first_name . ' ' . $data['student']->father_middle_name . ' ' . $data['student']->father_last_name }}</span>
                </div>
            @endif
        ...
        <div class="profile-info-row">
            ...
            @if($data['student']->father_residence_number != "")
                ...
                <div class="profile-info-value">
                    <span class="editable"
                        id="father_residence_number">{{ $data['student']->father_residence_number }}</span>
                </div>
            @endif
        </div>
        <div class="profile-info-row">
    ...
    <div class="profile-user-info profile-user-info-striped">
        <div class="profile-info-row">
            @if($data['student']->mother_first_name != "")
                ...
                <div class="profile-info-value">
                    <span class="editable"
                        id="temporary_place">{{ $data['student']->mother_first_name . ' ' . $data['student']->mother_middle_name . ' ' . $data['student']->mother_last_name }}</span>
                </div>
            @endif
        ...
        <div class="profile-info-row">
            ...
            @if($data['student']->mother_residence_number != "")
                ...
                <div class="profile-info-value">
                    <span class="editable"
                        id="mother_residence_number">{{ $data['student']->mother_residence_number }}</span>
                </div>
            @endif
        </div>
        <div class="profile-info-row">
    ...
    <div class="profile-user-info profile-user-info-striped">
        <div class="profile-info-row">
            @if($data['student']->guardian_first_name != "")
                ...
                <div class="profile-info-value">
                    <span class="editable"
                        id="temporary_place">{{ $data['student']->guardian_first_name . ' ' . $data['student']->guardian_middle_name . ' ' . $data['student']->guardian_last_name }}</span>
                </div>
            @endif
        ...
        <div class="profile-info-row">
            ...
            @if($data['student']->guardian_residence_number != "")
                ...
                <div class="profile-info-value">
                    <span class="editable"
                        id="guardian_residence_number">{{ $data['student']->guardian_residence_number }}</span>
                </div>
            @endif
        </div>
        <div class="profile-info-row">
...
<div class="row">
    ...
    <h3 class="text-uppercase text-center no-margin-top" style="font-family: 'Righteous', cursive; font-size: 16px">
        ...
        <div>
            ...
            <span class="profile-picture">
                @if($data['student']->guardian_image != '')
                    <img id="avatar" class="editable img-responsive" alt="Guardian"
                        src="{{ asset('images' . DIRECTORY_SEPARATOR . 'parents' . DIRECTORY_SEPARATOR . $data['student']->guardian_image) }}"
                        width="300px" />
                @else
                    <img id="avatar" class="editable img-responsive" alt=""
                        src="{{ asset('assets/images/avatars/profile-pic.jpg') }}" />
                @endif
            </span>
        </div>
        ...
        <div>
            ...
            <span class="profile-picture">
                @if($data['student']->father_image != '')
                    <img id="avatar" class="editable img-responsive" alt="Guardian"
                        src="{{ asset('images' . DIRECTORY_SEPARATOR . 'parents' . DIRECTORY_SEPARATOR . $data['student']->father_image) }}"
                        width="300px" />
                @else
                    <img id="avatar" class="editable img-responsive" alt=""
                        src="{{ asset('assets/images/avatars/profile-pic.jpg') }}" />
        ...
        <div>
            ...
            <span class="profile-picture">
                @if($data['student']->mother_image != '')
                    <img id="avatar" class="editable img-responsive" alt="Guardian"
                        src="{{ asset('images' . DIRECTORY_SEPARATOR . 'parents' . DIRECTORY_SEPARATOR . $data['student']->mother_image) }}"
                        width="300px" />
                @else
                    <img id="avatar" class="editable img-responsive" alt=""
                        src="{{ asset('assets/images/avatars/profile-pic.jpg') }}" />
