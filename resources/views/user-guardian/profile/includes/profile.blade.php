        ...
        <div>
            <span class="profile-picture">
               ...
               @if($student->student_image != '')
                    <img id="avatar" class="editable img-responsive" alt="{{ $student->title }}" src="{{ asset('images'.DIRECTORY_SEPARATOR.'studentProfile'.DIRECTORY_SEPARATOR.$data['student']->student_image) }}" width="300px" />
                @else
